        ...
        <div className="-mx-4 flex flex-wrap">
            ...
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                <h3 className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                  Apakah informasi yang disajikan di sini akurat dan terkini?
                </h3>
                <p className="text-base text-body-color dark:text-dark-6">
                  Kami memiliki tim penulis dan peneliti yang berpengalaman yang
                  memastikan bahwa setiap informasi yang kami sediakan akurat
                  dan terkini. Kami secara rutin memperbarui konten kami untuk
                  memastikan relevansi dan keakuratan informasi.
                </p>
              </div>
            </div>
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  IndonesiaKu adalah platform yang menyediakan panduan wisata
                  dan artikel budaya yang mendalam dan informatif. Kami
                  bertujuan untuk membantu para pelancong menemukan destinasi
                  menarik dan memahami keunikan budaya dari berbagai belahan
                  dunia.
                </p>
              </div>
            </div>
          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                <h3 className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                  Apa saja layanan yang ditawarkan oleh IndonesiaKu?
                </h3>
                <p className="text-base text-body-color dark:text-dark-6">
                  Kami menawarkan panduan wisata yang terperinci dan artikel
                  budaya yang informatif. Panduan wisata kami mencakup berbagai
                  destinasi, atraksi, dan tips perjalanan. Artikel budaya kami
                  menyoroti tradisi, seni, sejarah, dan kehidupan sehari-hari
            ...
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                <h3 className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                  Bagaimana cara menggunakan panduan wisata di situs Anda?
                </h3>
                <p className="text-base text-body-color dark:text-dark-6">
                  Anda dapat menjelajahi panduan wisata kami berdasarkan
                  kategori seperti lokasi, jenis aktivitas, atau tema tertentu.
                  Setiap panduan menyediakan informasi lengkap tentang
                  destinasi, termasuk atraksi utama, tips perjalanan, dan
